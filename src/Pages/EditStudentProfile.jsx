...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!isAdmin) {
        updatedData.track_name = formData.track_name;
        updatedData.department_id = formData.department_id || null;
      }
      ...
      if (response?.id || response?.status) {
        ...
        // 👈 💡 الحل هنا: نقوم بتحديث الـ Context بالبيانات الجديدة فوراً
  ...
  return (
    <>
      {/* الهيدر والسايدبار بيتحددوا حسب المسار الحالي */}
      {isAdmin ? (
        <>
          <Header />
          <Sidebar />
